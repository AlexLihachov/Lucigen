...
const sassVars = NODE_ENV === 'development' ?
    require(__dirname + "/src/js/variables.js") :
    require(__dirname + "/src/js/variables-prod.js");
