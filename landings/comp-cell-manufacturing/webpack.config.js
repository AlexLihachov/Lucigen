...
let cssOutputPath = NODE_ENV === 'development' ? '/../../comp-cell-manufacturing.css' : '/../../comp-cell-manufacturing-prod.css';
const extractAllCss = new ExtractTextPlugin(cssOutputPath);

/** Set paths to cleaning files before building */
let cleanFilesPaths = [
    '/es5/bundle.js',
    'comp-cell-manufacturing.css',
    'comp-cell-manufacturing.css.map'
];

if (NODE_ENV !== 'development') {
    cleanFilesPaths.push('comp-cell-manufacturing-prod.css');
    cleanFilesPaths = cleanFilesPaths.filter(el =>  el !== 'comp-cell-manufacturing.css');
}
...
module.exports = {
    ...
    plugins: [
        ...
        new BrowserSyncPlugin({
            ...
            files: ['index.html', 'comp-cell-manufacturing.css']
        })
    ]
};
