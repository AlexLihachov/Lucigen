...
let cssOutputPath = NODE_ENV === 'development' ? '/../../NGS-enzymes.css' : '/../../NGS-enzymes-prod.css';
...
if (NODE_ENV !== 'development') {
    cleanFilesPaths.push('NGS-enzymes-prod.css');
    cleanFilesPaths = cleanFilesPaths.filter(el =>  el !== 'NGS-enzymes.css');
}
...
module.exports = {
    ...
    plugins: [
        ...
        new BrowserSyncPlugin({
            ...
            files: ['index.html', 'NGS-enzymes.css']
        })
    ]
};
