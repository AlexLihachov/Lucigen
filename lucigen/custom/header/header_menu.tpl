    ...
    <div id="xmm_container">
      ...
      <ul class="sf-menu" id="resp_menu">
        ...
        <li>
          ...
          <ul>
            <li><a href="{$xcart_web_dir}/eLucidations-application-notes.html">Application Notes</a></li>
            <li><a href="{$xcart_web_dir}/Citations.html">Citations</a></li>
            <li><a href="pages.php?pageid=233">FAQs</a></li>
          ...
          {*  <li><a href="{$xcart_web_dir}/Selection-Guides.html">Product Selection Guides</a></li> *}
            ...
            <li><a href="pages.php?pageid=262">{$lng.lbl_white_papers}</a></li>
            {* FS - New resource in product categories # 86965 *}
          </ul>
        </li>
